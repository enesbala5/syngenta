...
export const navigation = {
	...
	support: [
		...
		{ name: 'Privacy Policy', href: route('/(app)/(homepage)') }, // TODO: Change to privacy policy once page is created
	],
	company: [
	...
	legal: [
		...
		{ name: 'Terms & Conditions', href: route('/(app)/(homepage)') }, // TODO: Change to terms & conditions once page is created
	],
	social: [
		{
			name: 'Facebook',
