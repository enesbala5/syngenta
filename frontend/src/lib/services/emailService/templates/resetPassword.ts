...
const templateHTML = ({
	...
	const resetPasswordURL = route('/(alternate)/(auth)/resetPassword/[id]', {
		baseUrl: baseURL,
		params: {
			id: data?.actionUrl,
		},
